...
import os.path
if os.path.isfile('ITC.h5') is False:
    model.save('ITC.h5')
...
t=1908-100
x_input=test_data[1808:].reshape(1,-1)
...
day_pred=np.arange(3642,5642)
print(len(lst_output))
plt.plot(day_new,scaler.inverse_transform(df2[1808:]))
plt.plot(day_pred,scaler.inverse_transform(lst_output))
plt.show()


filename = "DATA_ITC.csv"
fields =["Close"]
import csv 
